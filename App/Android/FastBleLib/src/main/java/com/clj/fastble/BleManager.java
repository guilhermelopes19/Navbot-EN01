...
public class BleManager {
    ...
    public void notify(BleDevice bleDevice,
        ...
        notify(bleDevice, uuid_service, uuid_notify, false,characteristic, callback);
    }
    ...
    public void notify(BleDevice bleDevice,
        ...
        if (bleBluetooth == null) {
            ...
            bleBluetooth.newBleConnector()
                    ...
                    .enableCharacteristicNotify(callback, uuid_notify, useCharacteristicDescriptor,characteristic);
        }
    }
    ...
    public void indicate(BleDevice bleDevice,
        ...
        if (bleBluetooth == null) {
            ...
            bleBluetooth.newBleConnector()
                    .withUUIDStringNotify(uuid_service, uuid_indicate)
